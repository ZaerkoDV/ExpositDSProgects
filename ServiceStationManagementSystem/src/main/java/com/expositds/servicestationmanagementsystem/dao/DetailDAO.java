...
/**
 * <p>The interface DetailDAO contain methods ads which realize in class DetailDAOImpl.
 * Class DetailDAOImpl use DAO pattern which describes layer of data access to object. DAO
 * layer perform link between relational and object model. Model for this dao layer describied
 * in class Detail.This interface contain ads methods which intended to access to operation
