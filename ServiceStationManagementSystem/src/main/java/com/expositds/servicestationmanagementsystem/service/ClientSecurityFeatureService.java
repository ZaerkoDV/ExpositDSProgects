...
/**
 * <p>The interface ClientSecurityFeatureService contain methods ads which realize in class
 * ClientSecurityFeatureServiceImpl. Class ClientSecurityFeatureService use Service pattern
 ...
 * Interface extend AbstractEntityCommonService interface which contain ads base operation of
 * any entity.
 * 
 * @version 1.0 18.08.2015
 * @author Zaerko Denis
 */
public interface ClientSecurityFeatureService extends AbstractEntityCommonService {
