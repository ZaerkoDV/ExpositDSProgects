...
/**
  * <p>The interface EntityUtilDAO contain methods ads which realize in class  EntityUtilDAOImpl.
  * Class EntityUtilDAOImpl use DAO pattern which describes layer of data access to object. This
  * class contain general operation to all model. This interface contain ads methods which intended
  * to access to operation with objects.Class  use Spring framework to work whith ORM. In particular
  * often use HibernateTemplate for integration Hibernate and Spring technologys. For work with data
  * base use hibernate criteria. 
 * 
 * @version 1.0 11.08.2015
 * @author Zaerko Denis
 */
public interface EntityUtilDAO {
