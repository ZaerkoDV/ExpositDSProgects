  ...
  <div class="container">
    <div class="row">
      ...
      <div class="row" style="padding-top: 150px;">
           ...
           <div class="col-md-2"><a href="<c:url value='/ServiceStationManagementSystem/request/${ServiceStation.id}' />"><button type="button" class="btn btn-danger">Make a request</button></a></div>
      </div>
      ...
      <form class="form-inline">
        ...
        <a href="#"><button type="submit" class="btn btn-default">Check</button></a>
      </form>
      <div class="row" style="padding-top: 50px;">
