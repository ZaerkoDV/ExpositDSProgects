 ...
 <h4>Not done</h4>
  <!--  c:if test="${!empty listDepartmentOrder}" -->
        ...
        <tr>
          ...
          <td>
          <div class="col-md-6"><input type="date" class="form-control" id="deadline" placeholder="Date"></div>
          </td>
          <td><a href="<c:url value='/mechanicpage/notdone/save/${DepartmentOrder.id}' />"><button type="button" class="btn btn-xs btn-primary">Save</button></a></td>
        </tr>
         <!-- /c:forEach -->
       </table>
       <!-- /c:if -->
