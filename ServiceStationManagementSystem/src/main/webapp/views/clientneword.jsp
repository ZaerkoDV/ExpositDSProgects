			  ...
			  <div class="container-fluid">
			    ...
			    <div>
			         <ul class="nav nav-pills navbar-right">
			           ...
			           <li><a class="btn btn-primary" href="/ServiceStationManagementSystem/profile/${idClient}/clientnotcompledoverdord">To notcompleted/overdue order </a></li>
			        </ul>
			    </div>
		    </div>
		 </nav>    
    
    	<form:form id="clientOrderForm" method="POST" class="bs-example form-horizontal" commandName="departmentOrder">
					     ...
					     <div class="modal-dialog">
							<div class="modal-content">				
								...
								<div class="modal-footer">
									<a href="/profile/${idClient}/clientneword"	class="btn btn-primary" data-dismiss="modal">No</a>
